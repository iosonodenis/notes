    ...
    <Box p={3} sx={{ borderRadius: 2 }} mb={2} bg="accent" color="text-light">
      ...
      <p sx={{ m: 0, fontSize: 1 }}>
        ...
        <Styled.a
          ...
          href="https://twitter.com/messages/compose?recipient_id=citofonaredenis"
        >
          direct message
        </Styled.a>{' '}
        on Twitter or an{' '}
        <Styled.a sx={{ textDecoration: 'underline', color: 'text-light' }} href="mailto:denisr@gmail.com">
          email
        </Styled.a>{' '}
        and we can talk.
      </p>
