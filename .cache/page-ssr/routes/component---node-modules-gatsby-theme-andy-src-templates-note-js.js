...
// EXTERNAL MODULE: ./node_modules/react-stacked-pages-hook/lib/index.js
var lib = __webpack_require__(1703);
// EXTERNAL MODULE: ./node_modules/prop-types/index.js
var prop_types = __webpack_require__(5697);
var prop_types_default = /*#__PURE__*/__webpack_require__.n(prop_types);
// EXTERNAL MODULE: ./node_modules/react-side-effect/lib/index.js
var react_side_effect_lib = __webpack_require__(3524);
...
var Helmet_objectWithoutProperties = function (obj, keys) {
  var target = {};
...
var Helmet_requestAnimationFrame = typeof window !== "undefined" ? window.requestAnimationFrame && window.requestAnimationFrame.bind(window) || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || rafPolyfill : global.requestAnimationFrame || rafPolyfill;

var Helmet_cancelAnimationFrame = typeof window !== "undefined" ? window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || cafPolyfill : global.cancelAnimationFrame || cafPolyfill;
...
var handleClientStateChange = function handleClientStateChange(newState) {
    if (_helmetCallback) {
        Helmet_cancelAnimationFrame(_helmetCallback);
    }

    if (newState.defer) {
        _helmetCallback = Helmet_requestAnimationFrame(function () {
    ...
    return _temp = _class = function (_React$Component) {
        ...
        HelmetWrapper.prototype.mapChildrenToProps = function mapChildrenToProps(children, newProps) {
            ...
            index_js_default().Children.forEach(children, function (child) {
                ...
                var _child$props = child.props,
                    ...
                    childProps = Helmet_objectWithoutProperties(_child$props, ["children"]);
        ...
        HelmetWrapper.prototype.render = function render() {
            var _props = this.props,
                ...
                props = Helmet_objectWithoutProperties(_props, ["children"]);
...
var dist_index_esm = __webpack_require__(5326);
...
/* harmony default export */ const layout_dist_index_esm = (layout);
...
/* harmony default export */ const color_dist_index_esm = (color);
...
var transforms = ['margin', 'marginTop', 'marginRight', 'marginBottom', 'marginLeft', 'marginX', 'marginY', 'top', 'bottom', 'left', 'right'].reduce(function (acc, curr) {
  ...
  return index_esm_extends({}, acc, (_extends2 = {}, _extends2[curr] = positiveOrNegative, _extends2));
}, {});
...
var css = function css(args) {
  return function (props) {
    ...
    var theme = index_esm_extends({}, defaultTheme, {}, props.theme || props);
    ...
    for (var key in styles) {
      ...
      if (key === 'variant') {
        ...
        result = index_esm_extends({}, result, {}, variant);
        continue;
      }
...
var width = layout_dist_index_esm.width,
    height = layout_dist_index_esm.height,
    minWidth = layout_dist_index_esm.minWidth,
    minHeight = layout_dist_index_esm.minHeight,
    maxWidth = layout_dist_index_esm.maxWidth,
    maxHeight = layout_dist_index_esm.maxHeight,
    size = layout_dist_index_esm.size,
    verticalAlign = layout_dist_index_esm.verticalAlign,
    display = layout_dist_index_esm.display,
    overflow = layout_dist_index_esm.overflow,
    overflowX = layout_dist_index_esm.overflowX,
    overflowY = layout_dist_index_esm.overflowY;
var opacity = color_dist_index_esm.opacity;
...
var createShouldForwardProp = function createShouldForwardProp(props) {
  ...
  return emotion_memoize_esm(function (prop) {
    return (0,is_prop_valid_esm/* default */.Z)(prop) && !regex.test(prop);
  });
};
/* harmony default export */ const should_forward_prop_dist_index_esm = (createShouldForwardProp(props));

// EXTERNAL MODULE: ./node_modules/@emotion/styled/dist/styled.esm.js + 1 modules
var styled_esm = __webpack_require__(7795);
// EXTERNAL MODULE: ./node_modules/@emotion/core/dist/core.esm.js + 8 modules
var core_esm = __webpack_require__(2121);
;// CONCATENATED MODULE: ./node_modules/@theme-ui/components/dist/index.esm.js
...
var shouldForwardProp = createShouldForwardProp(space_dist_index_esm.propNames.concat( color_dist_index_esm.propNames));

var sx = function (props) { return (0,dist_index_esm/* css */.i)(props.sx)(props.theme); };

var base = function (props) { return (0,dist_index_esm/* css */.i)(props.__css)(props.theme); };

var index_esm_variant = function (ref) {
  var theme = ref.theme;
  var variant = ref.variant;
  var __themeKey = ref.__themeKey; if ( __themeKey === void 0 ) __themeKey = 'variants';

  return (0,dist_index_esm/* css */.i)((0,dist_index_esm/* get */.U)(theme, __themeKey + '.' + variant, (0,dist_index_esm/* get */.U)(theme, variant)));
};

var Box = (0,styled_esm/* default */.Z)('div', {
  shouldForwardProp: shouldForwardProp
})({
  boxSizing: 'border-box',
  margin: 0,
  minWidth: 0
}, base, index_esm_variant, space_dist_index_esm, color_dist_index_esm, sx, function (props) { return props.css; });

var Flex = (0,styled_esm/* default */.Z)(Box)({
  display: 'flex'
});

function index_esm_objectWithoutProperties (obj, exclude) { var target = {}; for (var k in obj) if (Object.prototype.hasOwnProperty.call(obj, k) && exclude.indexOf(k) === -1) target[k] = obj[k]; return target; }
...
var Grid = index_js_default().forwardRef(function (ref$1, ref) {
  var width = ref$1.width;
  var columns = ref$1.columns;
  var gap = ref$1.gap; if ( gap === void 0 ) gap = 3;
  var rest = index_esm_objectWithoutProperties( ref$1, ["width", "columns", "gap"] );
  var props = rest;

  var gridTemplateColumns = !!width ? widthToColumns(width) : countToColumns(columns);
  return index_js_default().createElement( Box, Object.assign({}, { ref: ref }, props, { __themeKey: "grids", __css: {
    display: 'grid',
    gridGap: gap,
...
var Button = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "button", variant: "primary" }, props, { __themeKey: "buttons", __css: {
  appearance: 'none',
...
var Link = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "a", variant: "styles.a" }, props, { __themeKey: "links" })); });

var Text = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, variant: "default" }, props, { __themeKey: "text" })); });

var Heading = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "h2", variant: "heading" }, props, { __themeKey: "text", __css: {
  fontFamily: 'heading',
  fontWeight: 'heading',
  lineHeight: 'heading'
} })); });

var Image = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "img" }, props, { __themeKey: "images", __css: Object.assign({}, {maxWidth: '100%',
  height: 'auto'},
  props.__css) })); });

var Card = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, variant: "primary" }, props, { __themeKey: "cards" })); });

var Label = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "label", variant: "label" }, props, { __themeKey: "forms", __css: {
  width: '100%',
  display: 'flex'
} })); });

var Input = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "input", variant: "input" }, props, { __themeKey: "forms", __css: {
  display: 'block',
  width: '100%',
  p: 2,
  appearance: 'none',
...
var SVG = (function (ref) {
  ...
  return index_js_default().createElement( Box, Object.assign({}, { as: "svg", xmlns: "http://www.w3.org/2000/svg", width: size + '', height: size + '', viewBox: "0 0 24 24", fill: "currentcolor" }, props));
});
...
var MRE = /^m[trblxy]?$/;
var index_esm_getMargin = getProps(function (k) { return MRE.test(k); });
var omitMargin = getProps(function (k) { return !MRE.test(k); });

var DownArrow = function (props) { return index_js_default().createElement( SVG, props,
    index_js_default().createElement( 'path', { d: "M7 10l5 5 5-5z" })
  ); };

var Select = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, index_esm_getMargin(props), { sx: {
  display: 'flex'
} }),
    index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "select", variant: "select" }, omitMargin(props), { __themeKey: "forms", __css: {
    display: 'block',
    width: '100%',
    p: 2,
    appearance: 'none',
    ...
    index_js_default().createElement( DownArrow, { sx: {
    ml: -28,
    alignSelf: 'center',
    pointerEvents: 'none'
  } })
...
var Textarea = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "textarea", variant: "textarea" }, props, { __themeKey: "forms", __css: {
  display: 'block',
  width: '100%',
  p: 2,
  appearance: 'none',
...
var RadioChecked = function (props) { return index_js_default().createElement( SVG, props,
    index_js_default().createElement( 'path', { d: "M12 7c-2.76 0-5 2.24-5 5s2.24 5 5 5 5-2.24 5-5-2.24-5-5-5zm0-5C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z" })
  ); };

var RadioUnchecked = function (props) { return index_js_default().createElement( SVG, props,
    index_js_default().createElement( 'path', { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z" })
  ); };

var RadioIcon = function (props) { return index_js_default().createElement( (index_js_default()).Fragment, null,
    index_js_default().createElement( RadioChecked, Object.assign({}, props, { __css: {
    display: 'none',
    'input:checked ~ &': {
      display: 'block'
    }
  } })),
    index_js_default().createElement( RadioUnchecked, Object.assign({}, props, { __css: {
    display: 'block',
    'input:checked ~ &': {
      display: 'none'
    }
...
var Radio = index_js_default().forwardRef(function (ref$1, ref) {
  ...
  return index_js_default().createElement( Box, null,
      index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "input", type: "radio" }, props, { sx: {
    position: 'absolute',
    opacity: 0,
    zIndex: -1,
    width: 1,
    ...
    overflow: 'hidden'
      ...
      index_js_default().createElement( Box, { as: RadioIcon, 'aria-hidden': "true", __themeKey: "forms", variant: variant, className: className, sx: sx, __css: {
    // todo: system props??
    mr: 2,
    borderRadius: 9999,
    color: 'gray',
...
var CheckboxChecked = function (props) { return index_js_default().createElement( SVG, props,
    index_js_default().createElement( 'path', { d: "M19 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.11 0 2-.9 2-2V5c0-1.1-.89-2-2-2zm-9 14l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" })
  ); };

var CheckboxUnchecked = function (props) { return index_js_default().createElement( SVG, props,
    index_js_default().createElement( 'path', { d: "M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z" })
  ); };

var CheckboxIcon = function (props) { return index_js_default().createElement( (index_js_default()).Fragment, null,
    index_js_default().createElement( CheckboxChecked, Object.assign({}, props, { __css: {
    display: 'none',
    'input:checked ~ &': {
      display: 'block'
    }
  } })),
    index_js_default().createElement( CheckboxUnchecked, Object.assign({}, props, { __css: {
    display: 'block',
    'input:checked ~ &': {
      display: 'none'
    }
...
var Checkbox = index_js_default().forwardRef(function (ref$1, ref) {
  var className = ref$1.className;
  var sx = ref$1.sx;
  ...
  return index_js_default().createElement( Box, null,
      index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "input", type: "checkbox" }, props, { sx: {
    position: 'absolute',
    opacity: 0,
    zIndex: -1,
    width: 1,
    ...
    overflow: 'hidden'
      ...
      index_js_default().createElement( Box, { as: CheckboxIcon, 'aria-hidden': "true", __themeKey: "forms", variant: variant, className: className, sx: sx, __css: {
    mr: 2,
    borderRadius: 4,
    color: 'gray',
    'input:checked ~ &': {
...
var Slider = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "input", type: "range", variant: "slider" }, props, { __themeKey: "forms", __css: {
  display: 'block',
  width: '100%',
  height: 4,
  my: 2,
...
var Field = index_js_default().forwardRef(function (ref$1, ref) {
  ...
  return index_js_default().createElement( Box, index_esm_getMargin(props),
        index_js_default().createElement( Label, { htmlFor: name }, label),
        index_js_default().createElement( Control, Object.assign({}, { ref: ref, id: name, name: name }, omitMargin(props)))
      );
});

var Progress = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "progress", variant: "styles.progress" }, props, { __css: {
  display: 'block',
  width: '100%',
  height: '4px',
  margin: 0,
...
var Donut = index_js_default().forwardRef(function (ref$1, ref) {
  ...
  return index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "svg", viewBox: "0 0 32 32", width: size, height: size, strokeWidth: strokeWidth, fill: "none", stroke: "currentcolor", role: "img", 'aria-valuenow': value, 'aria-valuemin': min, 'aria-valuemax': max }, props, { __css: {
    color: 'primary'
  } }),
        title && index_js_default().createElement( 'title', null, title ),
        index_js_default().createElement( 'circle', { cx: 16, cy: 16, r: r, opacity: 1 / 8 }),
        index_js_default().createElement( 'circle', { cx: 16, cy: 16, r: r, strokeDasharray: C, strokeDashoffset: offset, transform: "rotate(-90 16 16)" })
      );
});
...
var spin = (0,core_esm/* keyframes */.F4)({
  from: {
...
var Spinner = index_js_default().forwardRef(function (ref$1, ref) {
  ...
  var C = 2 * r * Math.PI;
  var offset = C - 1 / 4 * C;
  return index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "svg", viewBox: "0 0 32 32", width: size, height: size, strokeWidth: strokeWidth, fill: "none", stroke: "currentcolor", role: "img" }, props, { __css: {
    color: 'primary',
    overflow: 'visible'
  } }),
        index_js_default().createElement( 'title', null, title ),
        index_js_default().createElement( 'circle', { cx: 16, cy: 16, r: r, opacity: 1 / 8 }),
        index_js_default().createElement( Box, { as: "circle", cx: 16, cy: 16, r: r, strokeDasharray: C, strokeDashoffset: offset, __css: {
...
var Avatar = index_js_default().forwardRef(function (ref$1, ref) {
  var size = ref$1.size; if ( size === void 0 ) size = 48;
  var rest = objectWithoutProperties$7( ref$1, ["size"] );
  var props = rest;

  return index_js_default().createElement( Image, Object.assign({}, { ref: ref, width: size, height: size, variant: "avatar" }, props, { __css: {
  borderRadius: 9999
} }));
});

var Badge = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, variant: "primary" }, props, { __themeKey: "badges", __css: {
  display: 'inline-block',
...
var IconButton = index_js_default().forwardRef(function (ref$1, ref) {
  var size = ref$1.size; if ( size === void 0 ) size = 32;
  var rest = objectWithoutProperties$8( ref$1, ["size"] );
  var props = rest;

  return index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "button", variant: "icon" }, props, { __themeKey: "buttons", __css: {
  appearance: 'none',
  display: 'inline-flex',
  alignItems: 'center',
...
var x = index_js_default().createElement( 'svg', { xmlns: "http://www.w3.org/2000/svg", width: "24", height: "24", fill: "currentcolor", viewBox: "0 0 24 24" },
    index_js_default().createElement( 'path', { d: "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z" })
  );
var Close = index_js_default().forwardRef(function (ref$1, ref) {
  var rest = objectWithoutProperties$9( ref$1, ["size"] );
  var props = rest;

  return index_js_default().createElement( IconButton, Object.assign({}, { ref: ref, title: "Close", 'aria-label': "Close", variant: "close" }, props, { children: x }));
});

var Alert = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, variant: "primary" }, props, { __themeKey: "alerts", __css: {
  display: 'flex',
  alignItems: 'center',
  px: 3,
  py: 2,
...
var Divider = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, as: "hr", variant: "styles.hr" }, props, { __css: {
  color: 'gray',
  m: 0,
  my: 2,
  border: 0,
...
var Embed = index_js_default().forwardRef(function (ref$1, ref) {
  ...
  return index_js_default().createElement( Box, Object.assign({}, props, { __css: {
  width: '100%',
  height: 0,
  ...
  overflow: 'hidden'
      ...
      index_js_default().createElement( Box, { ref: ref, as: "iframe", src: src, width: width, height: height, frameBorder: frameBorder, allowFullScreen: allowFullScreen, allow: allow, __css: {
    position: 'absolute',
    width: '100%',
    height: '100%',
    top: 0,
...
var AspectRatio = index_js_default().forwardRef(function (ref$1, ref) {
  var ratio = ref$1.ratio; if ( ratio === void 0 ) ratio = 4 / 3;
  var children = ref$1.children;
  var rest = objectWithoutProperties$b( ref$1, ["ratio", "children"] );
  var props = rest;

  return index_js_default().createElement( Box, { ref: ref, sx: {
  position: 'relative',
  overflow: 'hidden'
} },
      index_js_default().createElement( Box, { sx: {
    width: '100%',
    height: 0,
    paddingBottom: 100 / ratio + '%'
  } }),
      index_js_default().createElement( Box, Object.assign({}, props, { __css: {
    position: 'absolute',
    top: 0,
    right: 0,
    bottom: 0,
...
var AspectImage = index_js_default().forwardRef(function (ref$1, ref) {
  var ratio = ref$1.ratio;
  var rest = objectWithoutProperties$c( ref$1, ["ratio"] );
  var props = rest;

  return index_js_default().createElement( AspectRatio, { ratio: ratio },
    index_js_default().createElement( Image, Object.assign({}, { ref: ref }, props, { __css: {
    objectFit: 'cover'
  } }))
  );
});

var Container = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref, variant: "container" }, props, { __themeKey: "layout", __css: {
  width: '100%',
  maxWidth: 'container',
  mx: 'auto'
} })); });

var NavLink = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Link, Object.assign({}, { ref: ref, variant: "nav" }, props, { __css: {
  color: 'inherit',
  textDecoration: 'none',
  fontWeight: 'bold',
  display: 'inline-block',
...
var Message = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( Box, Object.assign({}, { ref: ref }, props, { __themeKey: "messages", __css: {
  padding: 3,
...
var MenuIcon = function (ref) {
  ...
  return index_js_default().createElement( Box, { as: "svg", xmlns: "http://www.w3.org/2000/svg", width: size, height: size, fill: "currentcolor", viewBox: "0 0 24 24", sx: {
  display: 'block',
  margin: 0
} },
    index_js_default().createElement( 'path', { d: "M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z" })
  );
};
var MenuButton = index_js_default().forwardRef(function (props, ref) { return index_js_default().createElement( IconButton, Object.assign({}, { ref: ref, title: "Menu", 'aria-label': "Toggle Menu", variant: "menu" }, props),
    index_js_default().createElement( MenuIcon, null )
  ); });


//# sourceMappingURL=index.esm.js.map

;// CONCATENATED MODULE: ./node_modules/gatsby-theme-andy/src/utils/useWindowWidth.js
const getWindowWidth=()=>{return typeof window==='undefined'?undefined:window.innerWidth;};/* harmony default export */ const useWindowWidth = (()=>{const[width,setWidth]=index_js_default().useState(getWindowWidth);index_js_default().useEffect(()=>{const handleResize=()=>{setWidth(getWindowWidth());};window.addEventListener('resize',handleResize);return()=>window.removeEventListener('resize',handleResize);},[]);return[width];});
// EXTERNAL MODULE: ./.cache/gatsby-browser-entry.js + 11 modules
var gatsby_browser_entry = __webpack_require__(7076);
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-andy/src/components/Header.js
/** @jsx jsx *//* harmony default export */ const Header = (({siteMetadata})=>(0,index_esm/* jsx */.tZ)("header",null,(0,index_esm/* jsx */.tZ)(Box,{py:2,px:3,sx:{borderBottom:'1px solid',borderColor:'gray'}},(0,index_esm/* jsx */.tZ)(gatsby_browser_entry.Link,{to:"/",sx:{fontWeight:'bold',color:'text',textDecoration:'none'}},siteMetadata.title))));
// EXTERNAL MODULE: ./node_modules/@babel/runtime/helpers/esm/defineProperty.js + 3 modules
var defineProperty = __webpack_require__(4572);
// EXTERNAL MODULE: ./node_modules/gatsby-plugin-mdx/index.js
var gatsby_plugin_mdx = __webpack_require__(7019);
...
// EXTERNAL MODULE: ./node_modules/@theme-ui/mdx/dist/index.esm.js
var mdx_dist_index_esm = __webpack_require__(5551);
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-andy/src/components/CustomLinkToStacked.js
const _excluded=["to","onClick","onMouseLeave","onMouseEnter"];const LinkToStacked=/*#__PURE__*/index_js_default().forwardRef((_ref,ref)=>{let{to,onClick,onMouseLeave,onMouseEnter}=_ref,restProps=(0,objectWithoutProperties/* default */.Z)(_ref,_excluded);const[,,,navigateToStackedPage,highlightStackedPage]=(0,lib.useStackedPage)();const onClickHandler=(0,index_js_.useCallback)(ev=>{ev.preventDefault();if(onClick)onClick(ev);const isMac=window.navigator.platform.toUpperCase().indexOf('MAC')>=0;/* Override command + click on MacOS and Ctrl + click on other OS */if(isMac&&ev.metaKey||!isMac&&ev.ctrlKey)window.open(to,'_blank');else navigateToStackedPage(to);},[navigateToStackedPage,to,onClick]);const onMouseEnterHandler=(0,index_js_.useCallback)(ev=>{highlightStackedPage(to,true);if(onMouseEnter){onMouseEnter(ev);}},[to,onMouseEnter,highlightStackedPage]);const onMouseLeaveHandler=(0,index_js_.useCallback)(ev=>{highlightStackedPage(to,false);if(onMouseLeave){onMouseLeave(ev);}},[to,onMouseLeave,highlightStackedPage]);return/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,Object.assign({},restProps,{to:to,ref:ref,onClick:onClickHandler,onMouseEnter:onMouseEnterHandler,onMouseLeave:onMouseLeaveHandler}));});
...
function tippy_esm_getProps(props, modifier) {
...
var inlinePositioning = {
  ...
  fn: function fn(instance) {
    ...
    function addModifier() {
      if (!isInternalUpdate) {
        setInternalProps(tippy_esm_getProps(instance.props, modifier));
      }
    }
...
var useIsomorphicLayoutEffect = tippy_react_esm_isBrowser ? index_js_.useLayoutEffect : index_js_.useEffect;
...
function TippyGenerator(tippy) {
  function Tippy(_ref) {
    ...
    return /*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment, null, children ? /*#__PURE__*/(0,index_js_.cloneElement)(children, {
...
var forwardRef = (function (Tippy, defaultProps) {
  return /*#__PURE__*/(0,index_js_.forwardRef)(function TippyWrapper(_ref, _ref2) {
    var children = _ref.children,
    ...
    return (
      ...
      // some reason
      index_js_default().createElement(Tippy, Object.assign({}, defaultProps, props), children ? /*#__PURE__*/(0,index_js_.cloneElement)(children, {
        ref: function ref(node) {
...
/* harmony default export */ const tippy_react_esm = (index);

//# sourceMappingURL=tippy-react.esm.js.map

// EXTERNAL MODULE: ./node_modules/tippy.js/animations/shift-away.css
var shift_away = __webpack_require__(966);
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-andy/src/components/Tippy.js
/* harmony default export */ const Tippy = (props=>/*#__PURE__*/index_js_default().createElement(tippy_react_esm,Object.assign({placement:"right",animation:"slide-away"},props)));
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-andy/src/components/MdxComponents.js
const MdxComponents_excluded=["href","popups","noPopups"];/** @jsx jsx */const AnchorTag=_ref=>{let{href,popups={},noPopups=false}=_ref,restProps=(0,objectWithoutProperties/* default */.Z)(_ref,MdxComponents_excluded);if(!href)href=restProps.to;if(!href.match(/^http/))return noPopups?(0,index_esm/* jsx */.tZ)(gatsby_browser_entry.Link,Object.assign({},restProps,{to:href,sx:{variant:'links.internal'}})):(0,index_esm/* jsx */.tZ)(Tippy,{content:popups[href.replace(/^\//,'')],placement:"right",animation:"shift-away"},(0,index_esm/* jsx */.tZ)(LinkToStacked,Object.assign({},restProps,{to:href,sx:{variant:'links.internal'}})));return (0,index_esm/* jsx */.tZ)("a",Object.assign({},restProps,{href:href}));};/* harmony default export */ const MdxComponents = ({a:AnchorTag});
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-andy/src/components/ReferredBlock.js
/** @jsx jsx *//* harmony default export */ const ReferredBlock = (({references})=>{const[width]=useWindowWidth();if(references.length>0){const RefLink=width<768?gatsby_browser_entry.Link:LinkToStacked;return (0,index_esm/* jsx */.tZ)((index_js_default()).Fragment,null,(0,index_esm/* jsx */.tZ)(Heading,{as:"h4",color:"text-light"},"Referred in"),(0,index_esm/* jsx */.tZ)("div",{sx:{mb:2}},references.map(reference=>{return (0,index_esm/* jsx */.tZ)(RefLink,{sx:{textDecoration:'none',color:'text-light',':hover':{color:'text'}},to:`/${reference.slug}`,key:reference.slug},(0,index_esm/* jsx */.tZ)("div",{sx:{py:2}},(0,index_esm/* jsx */.tZ)(mdx_dist_index_esm/* Styled.p */.RQ.p,{sx:{fontSize:2,m:0,color:'text-light'}},reference.title),(0,index_esm/* jsx */.tZ)(mdx_dist_index_esm/* Styled.p */.RQ.p,{sx:{fontSize:1,m:0,color:'text-light'}},reference.childMdx.excerpt)));})),(0,index_esm/* jsx */.tZ)("hr",{sx:{mx:'auto',width:64}}));}return null;});
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-andy/src/components/Footer.js
/** @jsx jsx */const Footer=({references})=>{return (0,index_esm/* jsx */.tZ)(Box,{p:3,sx:{borderRadius:2},mb:2,bg:"accent",color:"text-light"},(0,index_esm/* jsx */.tZ)(ReferredBlock,{references:references}),(0,index_esm/* jsx */.tZ)("p",{sx:{m:0,fontSize:1}},"If you think this note resonated, be it positive or negative, send me a",' ',(0,index_esm/* jsx */.tZ)(mdx_dist_index_esm/* Styled.a */.RQ.a,{sx:{textDecoration:'underline',color:'text-light'},href:"https://twitter.com/messages/compose?recipient_id="},"direct message"),' ',"on Twitter or an",' ',(0,index_esm/* jsx */.tZ)(mdx_dist_index_esm/* Styled.a */.RQ.a,{sx:{textDecoration:'underline',color:'text-light'},href:"#"},"email"),' ',"and we can talk."));};/* harmony default export */ const components_Footer = (Footer);
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-andy/src/components/Popover.js
/** @jsx jsx *//* harmony default export */ const Popover = (({reference})=>{return (0,index_esm/* jsx */.tZ)(Box,{bg:"background",p:3,sx:{borderRadius:2,boxShadow:'0 0 8px rgba(0, 0, 0, 0.125)'}},(0,index_esm/* jsx */.tZ)(mdx_dist_index_esm/* Styled.h3 */.RQ.h3,{sx:{my:3}},reference.title),(0,index_esm/* jsx */.tZ)(mdx_dist_index_esm/* Styled.p */.RQ.p,null,reference.childMdx.excerpt));});
// EXTERNAL MODULE: ./node_modules/gatsby-theme-andy/src/theme.js
var theme = __webpack_require__(8102);
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-andy/src/components/BrainNote.js
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);enumerableOnly&&(symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;})),keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{};i%2?ownKeys(Object(source),!0).forEach(function(key){(0,defineProperty/* default */.Z)(target,key,source[key]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(target,Object.getOwnPropertyDescriptors(source)):ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}return target;}/** @jsx jsx */const BrainNote=({note})=>{const[width]=useWindowWidth();const popups={};if(note.outboundReferenceNotes){note.outboundReferenceNotes.filter(reference=>!!reference.childMdx.excerpt).forEach((ln,i)=>{popups[ln.slug]=(0,index_esm/* jsx */.tZ)(Popover,{reference:ln});});}const AnchorTagWithPopups=props=>(0,index_esm/* jsx */.tZ)(MdxComponents.a,Object.assign({},props,{popups:popups,noPopups:width<768}));return (0,index_esm/* jsx */.tZ)(theme_provider_dist_index_esm/* ThemeProvider */.f,{theme:theme/* default */.Z,components:_objectSpread(_objectSpread({},MdxComponents),{},{a:AnchorTagWithPopups})},(0,index_esm/* jsx */.tZ)("div",{sx:{flex:'1'}},(0,index_esm/* jsx */.tZ)(mdx_dist_index_esm/* Styled.h1 */.RQ.h1,{sx:{my:3}},note.title),(0,index_esm/* jsx */.tZ)(gatsby_plugin_mdx.MDXRenderer,null,note.childMdx.body)),(0,index_esm/* jsx */.tZ)(components_Footer,{references:note.inboundReferenceNotes}));};/* harmony default export */ const components_BrainNote = (BrainNote);
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-andy/src/components/BrainNoteContainer.js
const BrainNoteContainer_excluded=["i"];/** @jsx jsx */const NOTE_WIDTH=576;// w-xl
const StackedPageWrapper=_ref=>{let{i}=_ref,rest=(0,objectWithoutProperties/* default */.Z)(_ref,BrainNoteContainer_excluded);return (0,index_esm/* jsx */.tZ)(lib.PageIndexProvider,{value:i},(0,index_esm/* jsx */.tZ)(NoteWrapper,Object.assign({},rest,{i:i})));};// A wrapper component to render the content of a page when stacked
const NoteWrapper=({children,slug,title,overlay,obstructed,highlighted,i})=>{return (0,index_esm/* jsx */.tZ)((index_js_default()).Fragment,null,(0,index_esm/* jsx */.tZ)(Flex,{bg:highlighted?'accent':'background',px:3,className:"note-container",sx:{flexDirection:'column',flexShrink:0,overflowY:'auto',position:[null,null,'sticky'],// here
maxWidth:['100%','100%','100vw'],boxShadow:overlay?`0 0 8px rgba(0, 0, 0, 0.125)`:'',width:['100%','100%',NOTE_WIDTH],left:40*i,right:-585}},(0,index_esm/* jsx */.tZ)(Box,{sx:{display:['none','none','block'],transition:'opacity',transitionDuration:100,opacity:obstructed?1:0}},(0,index_esm/* jsx */.tZ)(Box,{sx:{position:'absolute',zIndex:10,transform:'rotate(90deg)',transformOrigin:'left'},pb:2},(0,index_esm/* jsx */.tZ)(LinkToStacked,{to:slug,sx:{fontWeight:'bold',textDecoration:'none',color:'text'}},title||slug))),(0,index_esm/* jsx */.tZ)(Flex,{sx:{flexDirection:'column',minHeight:'100%',transition:'opacity',transitionDuration:100,opacity:obstructed?0:1}},children)));};const BrainNotesContainer=({slug,note,location,siteMetadata})=>{const[width]=useWindowWidth();// process data from gatsby pageQuery API
const processPageQuery=index_js_default().useCallback(x=>x.brainNote,[]);const[state,scrollContainer]=(0,lib.useStackedPagesProvider)({firstPage:{slug,data:{brainNote:note}},location,processPageQuery,pageWidth:NOTE_WIDTH});const{stackedPages,stackedPageStates}=state;let pages=stackedPages;let indexToShow;if(width<768){const activeSlug=Object.keys(state.stackedPageStates).find(slug=>state.stackedPageStates[slug].active);indexToShow=state.stackedPages.findIndex(page=>page.slug===activeSlug);if(indexToShow===-1){indexToShow=state.stackedPages.length-1;}pages=[state.stackedPages[indexToShow]];}return (0,index_esm/* jsx */.tZ)(Flex,{sx:{flexDirection:'column',height:'100vh',minHeight:'100vh'}},(0,index_esm/* jsx */.tZ)(HelmetExport,null,(0,index_esm/* jsx */.tZ)("meta",{charSet:"utf-8"}),(0,index_esm/* jsx */.tZ)("title",null,note.title," - ",siteMetadata.title)),(0,index_esm/* jsx */.tZ)(Header,{siteMetadata:siteMetadata}),(0,index_esm/* jsx */.tZ)(Flex,{ref:scrollContainer,sx:{flex:1,flexGrow:1,overflowX:[null,null,'auto'],overflowY:'hidden'}},(0,index_esm/* jsx */.tZ)(Flex,{className:"note-columns-container",sx:{minWidth:'unset',flexGrow:1,transition:[null,null,'width'],transitionDuration:100,width:['100%','100%',NOTE_WIDTH*(pages.length+1)]}},(0,index_esm/* jsx */.tZ)(lib.StackedPagesProvider,{value:state},pages.map((page,i)=>(0,index_esm/* jsx */.tZ)(StackedPageWrapper,{i:i,key:page.slug,slug:page.slug,title:page.data.title,overlay:stackedPageStates[page.slug]&&stackedPageStates[page.slug].overlay,obstructed:indexToShow!==undefined?false:stackedPageStates[page.slug]&&stackedPageStates[page.slug].obstructed,highlighted:stackedPageStates[page.slug]&&stackedPageStates[page.slug].highlighted},(0,index_esm/* jsx */.tZ)(components_BrainNote,{note:page.data})))))));};/* harmony default export */ const BrainNoteContainer = (BrainNotesContainer);
;// CONCATENATED MODULE: ./node_modules/gatsby-theme-andy/src/templates/note.js
/* harmony default export */ const note = (props=>{return/*#__PURE__*/index_js_default().createElement(BrainNoteContainer,{note:props.data.brainNote,location:props.location,slug:props.pageContext.slug,siteMetadata:props.data.site.siteMetadata});});const query="3533409152";
 ...
 */const MDXRenderer=__webpack_require__(3725);module.exports={MDXRenderer:MDXRenderer};
...
var _defineProperty=__webpack_require__(8416);var _objectWithoutProperties=__webpack_require__(215);const _excluded=["scope","children"];function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);enumerableOnly&&(symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;})),keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{};i%2?ownKeys(Object(source),!0).forEach(function(key){_defineProperty(target,key,source[key]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(target,Object.getOwnPropertyDescriptors(source)):ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}return target;}const React=__webpack_require__(3666);const{mdx}=__webpack_require__(3905);const{useMDXScope}=__webpack_require__(3027);module.exports=function MDXRenderer(_ref){let{scope,children}=_ref,props=_objectWithoutProperties(_ref,_excluded);const mdxScope=useMDXScope(scope);// Memoize the compiled component
...
*/
var aa=__webpack_require__(3666),ca=__webpack_require__(3840);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
var React = __webpack_require__(3666);
...
const react_1 = __importStar(__webpack_require__(3666));
const gatsby_1 = __webpack_require__(7076);
const hooks_1 = __webpack_require__(4440);
exports.LinkToStacked = react_1.default.forwardRef((_a, ref) => {
    var { to, onClick, onMouseLeave, onMouseEnter } = _a, restProps = __rest(_a, ["to", "onClick", "onMouseLeave", "onMouseEnter"]);
    const [, , , navigateToStackedPage, highlightStackedPage,] = hooks_1.useStackedPage();
    const onClickHandler = react_1.useCallback((ev) => {
        ev.preventDefault();
        if (onClick) {
            onClick(ev);
        }
    ...
    const onMouseEnterHandler = react_1.useCallback((ev) => {
        highlightStackedPage(to, true);
        if (onMouseEnter) {
            onMouseEnter(ev);
        }
    }, [to, onMouseEnter, highlightStackedPage]);
    const onMouseLeaveHandler = react_1.useCallback((ev) => {
        highlightStackedPage(to, false);
        if (onMouseLeave) {
            onMouseLeave(ev);
        }
    }, [to, onMouseLeave, highlightStackedPage]);
    return (react_1.default.createElement(gatsby_1.Link, Object.assign({}, restProps, { to: to /*
        // @ts-ignore */, ref: ref, onClick: onClickHandler, onMouseEnter: onMouseEnterHandler, onMouseLeave: onMouseLeaveHandler })));
});
...
const react_1 = __webpack_require__(3666);
...
exports.PageIndexProvider = exports.StackedPagesIndexContext.Provider;
...
const react_1 = __webpack_require__(3666);
const gatsby_1 = __webpack_require__(7076);
const querystring_1 = __importDefault(__webpack_require__(9819));
const lodash_throttle_1 = __importDefault(__webpack_require__(3096));
const lodash_isequal_1 = __importDefault(__webpack_require__(2307));
const contexts_1 = __webpack_require__(9276);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(9276), exports);
__exportStar(__webpack_require__(4440), exports);
__exportStar(__webpack_require__(7843), exports);
...
;
//# sourceMappingURL=component---node-modules-gatsby-theme-andy-src-templates-note-js.js.map